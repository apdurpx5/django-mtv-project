...
class UserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['username','profile_image', 'first_name', 'last_name','email', 'nid', 'age', 'medical_info']  
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            ...
            self.fields['profile_image'].widget.attrs['class'] = 'form-control h-auto p-3'
            self.fields['profile_image'].widget.attrs['placeholder'] = 'Add profile image'
            self.fields['profile_image'].widget.attrs['value'] = userProfile_instance.profile_image
